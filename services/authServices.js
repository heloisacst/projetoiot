...
var validateUserEmailAndPassword = function(email, password) { // funcao que verifica se email e senha confere
...
var rand = function() { //funcao para gerar cód aleatório p cada usuário (quando faz o login = cookies)
